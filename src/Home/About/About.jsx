        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col-reverse lg:flex-row">
                <div className='relative'>
                    <img src={about2} className="w-3/4 lg:w-3/4 rounded-lg shadow-2xl" />
                    <img src={about1} className="w-3/4 lg:w-1/2 right-3 top-1/2 lg:absolute rounded-lg border-8 border-white shadow-2xl" />
                </div>
                <div className='lg:w-1/2'>
                    <h1 className="text-3xl lg:text-5xl font-semibold border-b-2 border-red-700">About <span className='text-red-700 font-extrabold'>G</span>ulshan<span className='text-red-700 font-extrabold'>P</span>ride</h1>
